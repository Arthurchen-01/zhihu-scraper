"""
creator_metadata.py - Creator archive metadata serialization and README rendering (v3.0 Core).
"""
...
from .contracts import CreatorSaveResult, SaveRunResult, SavedContentRecord
